//! Self-implemented HMAC-MD5 and SHA1 are available when dependencies are minimized, and the performance gap is negligible for the small amount of data we pass on

use super::byte2hex::bytes_to_hex_fast;
...
pub fn md5_hmac(data: &str, key: &str) -> String {
    ...
    let digest = hmac.compute(data.as_bytes());
